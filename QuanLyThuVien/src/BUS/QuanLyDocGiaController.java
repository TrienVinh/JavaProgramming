...
public class QuanLyDocGiaController {
	...
	String[] columnName = { "STT", "Mã ĐG", "Họ", "Tên", "Giới Tính", "Ngày Sinh", "Địa Chỉ", "Nghề Nghiệp", "CMND",
			"Email", "Số Điện Thoại" };
...
//		Sét lại mã độc giả theo số lượng danh sách độc giả.
		if (listItem.size() > 0) {
