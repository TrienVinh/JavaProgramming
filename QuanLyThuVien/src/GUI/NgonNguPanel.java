...
import BUS.QuanLyNgonNguController;

public class NgonNguPanel extends JPanel {
	private static final long serialVersionUID = 1L;
	private JTextField jtfTenNgonNgu;
	private JTextField jtfMaNgonNgu;
	...
	public NgonNguPanel() {
		...
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup()
						.addComponent(jpbInfo, GroupLayout.PREFERRED_SIZE, 210, GroupLayout.PREFERRED_SIZE).addGap(10)
		...
		JLabel lblThngTinTi = new JLabel("THÔNG TIN NGÔN NGỮ");
		...
		JLabel lblTnngNhp = new JLabel("Mã Ngôn Ngữ :");
		lblTnngNhp.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblTnngNhp.setForeground(new Color(255, 255, 255));

		JLabel lblMtKhu = new JLabel("Tên Ngôn Ngữ :");
		lblMtKhu.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblMtKhu.setForeground(new Color(255, 255, 255));

		jtfTenNgonNgu = new JTextField();
		jtfTenNgonNgu.setFont(new Font("Tahoma", Font.PLAIN, 16));
		jtfTenNgonNgu.setColumns(10);

		jtfMaNgonNgu = new JTextField();
		jtfMaNgonNgu.setFont(new Font("Tahoma", Font.PLAIN, 16));
		jtfMaNgonNgu.setColumns(10);
		...
		gl_jpbInfo.setHorizontalGroup(gl_jpbInfo.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_jpbInfo.createSequentialGroup().addContainerGap()
						.addComponent(lblThngTinTi, GroupLayout.DEFAULT_SIZE, 916, Short.MAX_VALUE).addContainerGap())
				.addGroup(
						gl_jpbInfo.createSequentialGroup().addGap(56).addComponent(lblTnngNhp).addGap(26)
								.addComponent(jtfMaNgonNgu, GroupLayout.PREFERRED_SIZE, 260, GroupLayout.PREFERRED_SIZE)
								.addGap(31).addComponent(lblMtKhu).addGap(18)
								.addComponent(jtfTenNgonNgu, GroupLayout.PREFERRED_SIZE, 273,
										GroupLayout.PREFERRED_SIZE)
								.addGap(82))
				.addGroup(gl_jpbInfo.createSequentialGroup().addContainerGap().addGroup(
						gl_jpbInfo.createParallelGroup(Alignment.LEADING).addGroup(gl_jpbInfo.createSequentialGroup()
								.addComponent(btnThem, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE).addGap(73)
								.addComponent(btnSua, GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE).addGap(67)
								.addComponent(btnXoa, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE).addGap(88)
								.addComponent(btnInBaoCao, GroupLayout.DEFAULT_SIZE, 194, Short.MAX_VALUE).addGap(12))
								.addGroup(
										gl_jpbInfo.createSequentialGroup().addGap(46)
												.addGroup(gl_jpbInfo.createParallelGroup(Alignment.LEADING)
														.addComponent(jlbMsg).addComponent(lblNhapThongTin))
												.addGap(749)))
						.addGap(37)));
		gl_jpbInfo.setVerticalGroup(gl_jpbInfo.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_jpbInfo.createSequentialGroup().addContainerGap().addComponent(lblThngTinTi).addGap(18)
						.addGroup(gl_jpbInfo.createParallelGroup(Alignment.BASELINE).addComponent(lblTnngNhp)
								.addComponent(jtfMaNgonNgu, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblMtKhu).addComponent(jtfTenNgonNgu, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap(18)
						.addGroup(gl_jpbInfo.createParallelGroup(Alignment.LEADING).addComponent(lblNhapThongTin)
		...
		QuanLyNgonNguController control = new QuanLyNgonNguController(jtfMaNgonNgu, jtfTenNgonNgu, jtfSearch, btnThem,
