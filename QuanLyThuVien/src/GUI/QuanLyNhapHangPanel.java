...
import BUS.QuanLyPhieuNhapController;
...
public class QuanLyNhapHangPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public QuanLyNhapHangPanel(JFrame frame, String maNV) {
		...
		QuanLyPhieuNhapController control = new QuanLyPhieuNhapController(jtfSearch, btnThem, jpnView, frame, maNV);
		control.setView();
		control.setEvent();
	}
}
