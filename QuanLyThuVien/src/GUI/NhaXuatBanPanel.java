...
import BUS.QuanLyNXBController;

public class NhaXuatBanPanel extends JPanel {
	private static final long serialVersionUID = 1L;
	private JTextField jtfTenNXB;
	private JTextField jtfMaNXB;
	...
	public NhaXuatBanPanel() {
		...
		jtfTenNXB = new JTextField();
		jtfTenNXB.setFont(new Font("Tahoma", Font.PLAIN, 14));
		jtfTenNXB.setColumns(10);

		jtfMaNXB = new JTextField();
		jtfMaNXB.setFont(new Font("Tahoma", Font.PLAIN, 14));
		jtfMaNXB.setColumns(10);
		...
		JLabel lblThngTinTi = new JLabel("THÔNG TIN NHÀ XUẤT BẢN");
		...
		gl_jpbInfo.setHorizontalGroup(
			gl_jpbInfo.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_jpbInfo.createSequentialGroup()
					.addGap(10)
					.addComponent(lblThngTinTi, GroupLayout.DEFAULT_SIZE, 969, Short.MAX_VALUE)
					.addGap(10))
				.addGroup(gl_jpbInfo.createSequentialGroup()
					.addGap(56)
					.addComponent(lblTnngNhp)
					.addGap(21)
					.addComponent(jtfMaNXB, GroupLayout.PREFERRED_SIZE, 232, GroupLayout.PREFERRED_SIZE)
					.addGap(170)
					.addComponent(lblMNhnVin, GroupLayout.PREFERRED_SIZE, 53, GroupLayout.PREFERRED_SIZE)
					.addGap(21)
					.addComponent(jtfDiaChi, GroupLayout.PREFERRED_SIZE, 244, GroupLayout.PREFERRED_SIZE))
				.addGroup(gl_jpbInfo.createSequentialGroup()
					.addGap(56)
					.addComponent(lblMtKhu, GroupLayout.PREFERRED_SIZE, 69, GroupLayout.PREFERRED_SIZE)
					.addGap(10)
					.addComponent(jtfTenNXB, GroupLayout.PREFERRED_SIZE, 232, GroupLayout.PREFERRED_SIZE)
					.addGap(170)
					.addComponent(lblQuyn, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE)
					.addGap(4)
					.addComponent(jtfEmail, GroupLayout.PREFERRED_SIZE, 244, GroupLayout.PREFERRED_SIZE))
				.addGroup(gl_jpbInfo.createSequentialGroup()
					.addGap(56)
					.addComponent(jlbMsg))
				.addGroup(gl_jpbInfo.createSequentialGroup()
					.addGap(10)
					.addComponent(btnThem, GroupLayout.PREFERRED_SIZE, 184, GroupLayout.PREFERRED_SIZE)
					.addGap(80)
					.addComponent(btnSua, GroupLayout.PREFERRED_SIZE, 183, GroupLayout.PREFERRED_SIZE)
					.addGap(99)
					.addComponent(btnXoa, GroupLayout.PREFERRED_SIZE, 170, GroupLayout.PREFERRED_SIZE)
					.addGap(46)
				...
				.addGroup(gl_jpbInfo.createSequentialGroup()
					...
					.addGroup(gl_jpbInfo.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_jpbInfo.createSequentialGroup()
							.addGap(2)
							.addComponent(lblTnngNhp))
						.addComponent(jtfMaNXB, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_jpbInfo.createSequentialGroup()
							.addGap(4)
							.addComponent(lblMNhnVin))
						.addGroup(gl_jpbInfo.createSequentialGroup()
							.addGap(2)
							.addComponent(jtfDiaChi, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
					.addGap(16)
					.addGroup(gl_jpbInfo.createParallelGroup(Alignment.LEADING)
						.addComponent(lblMtKhu)
						.addComponent(jtfTenNXB, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_jpbInfo.createSequentialGroup()
							.addGap(4)
							.addComponent(lblQuyn))
						.addGroup(gl_jpbInfo.createSequentialGroup()
							.addGap(2)
		...
		QuanLyNXBController control = new QuanLyNXBController(jtfMaNXB, jtfTenNXB, jtfDiaChi, jtfEmail, btnThem, btnSua,
				btnXoa, btnInBaoCao, jlbMsg, jpnView, jtfSearch);
		control.setView();
		control.setEvent();
	}
